...
//  PickleballReferee
//
//  Created by Tom Trompeter on 9/8/22.
//
...
class ScoringImages: Object, ObjectKeyIdentifiable {
    
    @Persisted(primaryKey: true) var id: ObjectId
    @Persisted(originProperty: "images") var match: LinkingObjects<Match>
    
    override class func primaryKey() -> String? {
        return "id"
    }
    
    @Persisted var blankBox = Constants.BOX_BLANK
